...
# from flask_cors import CORS
#   # Import the Cors class from flask_socketio
...
def send_otp():
    ...
    msg = MIMEMultipart()
    msg['From'] = 's4373395@gmail.com'  # Replace with your email address
    msg['To'] = email
    ...
    with smtplib.SMTP('smtp.gmail.com', 587) as server:  # Replace with your SMTP server details
        server.starttls()
        server.login('s4373395@gmail.com', 'koblqkuibzcminsg')  # Replace with your email and password
